...
const contactInfo = [
  ...
  { icon: Mail, label: 'Email', value: 'loftcommunity698@gmail.com', href: 'mailto:loftcommunity698@gmail.com' },
  { icon: Phone, label: 'Phone', value: '+1 (206) 218 7321', href: 'tel:+15551234567' },
